...
# This script will determine if we are operating inside a SandBox environment
...
# This method tells us how many clicks and the time of the clicks and how many keystrokes
    ...
    def detect(self):
        ...
        max_keystrokes = random.randit(10,25)
        max_mouse_clicks = radom.randit(5,25)
